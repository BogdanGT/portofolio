...
function Home() {
    ...
    return (
        <div className="App">
            ...
            <div className="h-[100%] sm:py-[150px] max-sm:py-[100px] flex flex-col justify-center sm:bg-[url('https://i.postimg.cc/cHT3skRj/boost-wallpaper.png')] max-sm:bg-[url('https://i.postimg.cc/4xPcqcw8/boost-wallpaper-mobile.png')] bg-no-repeat bg-center sm:bg-contain max-sm:bg-cover">
                <RevealAnimation>
